...
export const Route = createFileRoute("/customer")({
  head: () => ({
    meta: [
      { title: "Customer Fuel Request Form — FEFTMS" },
      { name: "description", content: "Submit a customer fuel request online." },
    ],
  }),
...
const EMERGENCY_LEVELS = [
  ...
  {
    level: "Critical",
    desc: "Stranded / Dangerous environment / Emergency situation",
    highlight: true,
  },
];
...
function CustomerPortal() {
  ...
  const visibleProducts = products.filter(
    (p) => p.unitPrice != null && p.unitPrice > 0 && p.status?.toLowerCase() !== "deleted",
  );
  ...
  const handleGPSDetect = () => {
    ...
    navigator.geolocation.getCurrentPosition(
      ...
      (error) => {
        console.error(error);
        alert(
          "Failed to auto-detect location. Please verify browser location permissions or fill in your address manually.",
        );
        setGpsLoading(false);
      },
  ...
  const handleMapClick = (e) => {
    ...
    setForm((s) => ({
      ...
      locationAddress: s.locationAddress.trim()
        ? s.locationAddress
        : `Simulated Map Pin (X: ${x.toFixed(1)}%, Y: ${y.toFixed(1)}%)`,
    }));
    // Clear location address validation error if it exists
    setErrors((errs) => {
      const copy = { ...errs };
  ...
  // Auto-reset form 1 second after successful submission
  useEffect(() => {
    if (submitted) {
    ...
    <div className="fef-page">
      ...
      <main className="fef-wizard-container fef-fade-in">
        <div className="fef-form-head">
          <h1>Customer Fuel Request Form</h1>
          <p>Submit your request for fuel delivery.</p>
        </div>
        ...
        {submitted ? (
          <div
            className="fef-card fef-success-card"
            style={{ padding: "40px 24px", textAlign: "center", borderRadius: 12 }}
          >
            <FiCheckCircle size={48} style={{ color: "var(--feftms-success)", marginBottom: 16 }} />
            <h2 style={{ fontSize: "1.5rem", fontWeight: 700, marginBottom: 12 }}>
              Fuel Request Submitted
            </h2>
            <p style={{ color: "var(--feftms-text-muted)", fontSize: "1.1rem" }}>
              Fuel request submitted successfully.
            </p>
          </div>
        ) : (
          <>
            ...
            <div className="fef-card fef-form">
                    ...
                    <div className="fef-field">
                      ...
                      {errors.driverName && (
                        <span className="fef-field-error">
                          <FiAlertCircle /> {errors.driverName}
                        </span>
                      )}
                    </div>
                    <div className="fef-field">
                      ...
                      {errors.driverPhone && (
                        <span className="fef-field-error">
                          <FiAlertCircle /> {errors.driverPhone}
                        </span>
                      )}
                    </div>
                    <div className="fef-field">
                      ...
                      {errors.driverEmail && (
                        <span className="fef-field-error">
                          <FiAlertCircle /> {errors.driverEmail}
                        </span>
                      )}
                    </div>
                  </div>
              ...
              {step === 1 && (
                <div className="fef-fade-in">
                  <h3 style={{ marginBottom: 18, fontWeight: 700 }}>Delivery Location</h3>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                    <div className="fef-field">
                      ...
                      {errors.locationAddress && (
                        <span className="fef-field-error">
                          <FiAlertCircle /> {errors.locationAddress}
                        </span>
                      )}
                    </div>
                    ...
                    <div className="fef-field">
                      ...
                      <div className="fef-map-simulator" onClick={handleMapClick}>
                        ...
                        <div className="fef-map-landmark" style={{ top: "30px", left: "20px" }}>
                          A104 Highway
                        </div>
                        <div className="fef-map-landmark" style={{ bottom: "20px", right: "40px" }}>
                          Nairobi Valley
                        </div>
              ...
              {step === 2 && (
                <div className="fef-fade-in">
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
                    <div className="fef-field">
                      <label className="fef-label" style={{ marginBottom: 8 }}>
                        Fuel Type Needed
                      </label>
                      {visibleProducts.length === 0 ? (
                        <div className="fef-alert fef-alert-warning" style={{ marginTop: 10 }}>
                          No fuel products have been configured yet. Finance will publish pricing as
                          soon as new products are added.
                        </div>
                      ) : (
                        <div className="fef-selection-grid">
                          {visibleProducts.map((prod) => {
                            const isSelected =
                              form.fuelType.toLowerCase() === prod.fuelType?.toLowerCase();
                            return (
                              <div
                                key={prod.id}
                              ...
                              >
                                <span className="fef-selection-card-icon">
                                  <FiDroplet />
                                </span>
                                <h4
                                  className="fef-selection-card-title"
              ...
              {step === 3 && (
                <div className="fef-fade-in">
                  <h3 style={{ marginBottom: 18, fontWeight: 700 }}>Urgency Level</h3>
                    ...
                    {EMERGENCY_LEVELS.map((el) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <div>
                            <h4 className="fef-selection-card-title" style={{ fontSize: 16 }}>
                              {el.level}
                            </h4>
                            <p
                              style={{
                    ...
                    >
                      <div>
                        ...
                        >
                          ...
                          {form.driverEmail && (
                            <div>
                              <strong>Customer Email:</strong> {form.driverEmail}
                            </div>
                          )}
                          <div>
                            <strong>Delivery Location:</strong> {form.locationAddress}
                          </div>
                          {form.locationGps && (
                            <div>
                              <strong>GPS coordinates:</strong> {form.locationGps}
                            </div>
                          )}
                          {form.locationLandmark && (
                            <div>
                              <strong>Landmark:</strong> {form.locationLandmark}
                            </div>
                          )}
                          <div>
                      ...
                      <div>
                        ...
                        >
                          ...
                          <div>
                            <strong>Order Date:</strong> {formatDateLong(new Date().toISOString())}
                          </div>
                          <div>
                          ...
                          <div>
                            ...
                            <span
                              className="fef-badge fef-badge-pending"
                        ...
                        <tbody>
                          <tr style={{ borderBottom: "1px solid rgba(255, 255, 255, 0.04)" }}>
                            <td style={{ padding: "12px 0", fontWeight: 600 }}>
                              {form.fuelType === "Petrol" || form.fuelType === "PMS"
                              ...
                              >
                                {form.fuelType === "Petrol" || form.fuelType === "PMS"
                                  ? "Premium Motor Spirit – Automotive Gasoline 90 RON (East African Standards)"
                                  : "Automotive Gasoil – Diesel 50 ppm (East African Standards)"}
                              </span>
                            </td>
                            <td style={{ textAlign: "right", padding: "12px 0" }}>
                              {Number(form.quantity).toLocaleString()} Litres
                              <span
                                style={{
                                  display: "block",
                                  fontSize: 11,
                              ...
                              >
                                {(Number(form.quantity) / 1000).toFixed(3)} CBM
                              </span>
                            </td>
                            <td style={{ textAlign: "right", padding: "12px 0" }}>
                              US$ {Number(getSelectedProduct()?.unitPrice || 0).toFixed(2)}
                              <span
                                style={{
                                  display: "block",
                                  fontSize: 11,
                              ...
                              >
                                US${" "}
                                {Number(
                                  (getSelectedProduct()?.unitPrice || 0) * 1000,
              ...
              <div className="fef-wizard-actions">
                ...
                {step < STEPS.length - 1 ? (
                  <button type="button" className="fef-btn fef-btn-primary" onClick={handleNext}>
                    Next <FiArrowRight />
                  </button>
                ) : (
                  <button
                    ...
                    style={{
                      ...
                      boxShadow:
                        form.emergencyLevel === "Critical"
                          ? "0 8px 20px -8px rgba(198,40,40,0.5)"
                          : "inherit",
                    }}
                  >
                    {loading ? (
      ...
      {!submitted && step === STEPS.length - 1 && (
        <div className="fef-sticky-cta-footer hide-on-desktop">
          ...
          >
            {loading ? "Submitting..." : "Request Fuel"}
          </button>
        </div>
      )}
    </div>
