...
public interface FlutterwaveClient {
    ...
    record ChargeResult(String id, String reference, String providerReference, BigDecimal amount, String currency,
                        String status, String nextActionType, String redirectUrl, String instruction,
