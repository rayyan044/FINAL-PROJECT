      ...
      >
        ...
        >
          <View style={styles.hero}>
            ...
            <View style={styles.logoPlaceholder} accessibilityLabel="Falcon Energy logo">
          ...
          <View style={styles.card}>
            ...
            <View style={styles.form}>
              ...
              <View accessibilityLiveRegion="polite" style={styles.errorArea}>
                {error ? <View style={styles.errorBanner}><Ionicons color={colors.danger} name="alert-circle-outline" size={18} /><Text style={styles.errorText}>{error}</Text></View> : null}
              </View>
...
const styles = StyleSheet.create({
  ...
  hero: { backgroundColor: colors.primary, minHeight: 286, overflow: "hidden", paddingHorizontal: 24, paddingTop: 52 },
  heroGlow: { backgroundColor: colors.brightBlue, borderRadius: 160, height: 300, opacity: 0.38, position: "absolute", right: -125, top: -135, width: 300 },
  brandSection: {
    alignItems: "center",
    position: "relative",
  },
